...
### 1. 学习路线
- 前一两个月，是读一些关于图像美学评估和图像质量评估方面的论文或博客，了解图像美学评估是什么，并会给你初拟一个方向，你带着问题看文献，另外python和Pytorch没有基础的同学，需要在这段时间补一些基础；
- 第三个月之后，重点看一些有开源代码的文章，尝试跑一跑代码。
- 代码玩的比较熟，可以尝试结合研究方向，魔改代码，找到创新点。
- 实验结果符合预期，开始参与论文写作，或负责论文写作。
...
## 常见问题答疑
- 我怎样才能进入实验室实习或读研？ 联系实验室老师，由老师或博士生面试后，即可进入实习。
